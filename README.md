...
| `authn_htpasswd_filename` | string  | If you would like to use htpasswd to authenticate users to the cluster, enter the filename of the htpasswd file.  This file should be uploaded to the Azure 'dllsshare' file share in order for the HPCC processes to find it.  An empty string indicates that htpasswd is not to be used for authentication. ***This is OPTIONAL, defaulting to an empty string.*** | Y |
